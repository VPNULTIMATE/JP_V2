...
function run_setup() {
    ...
    wget -O zi.sh https://raw.githubusercontent.com/Pemulaajiw/udp-zivpn/main/zi.sh
    ...
    wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/Pemulaajiw/udp-zivpn/main/zivpn_helper.sh
    if [ $? -ne 0 ]; then

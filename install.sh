...
function create_manual_account() {
    ...
    if [[ "$result" == "Success"* ]]; then
        ...
        if [ -n "$user_line" ]; then
            ...
            clear
            echo "🔹Informasi Akun JP OFFICIAL Anda🔹"
            echo "┌─────────────────────"
            echo "│ Host: $HOST"
            echo "│ Pass: $password"
...
function create_account() {
    ...
    echo -e "${YELLOW}║                                                    ║${NC}"
    echo -e "${YELLOW}║   ${RED}1)${NC} ${BOLD_WHITE}Create JP OFFICIAL                           ${YELLOW}║${NC}"
    echo -e "${YELLOW}║   ${RED}2)${NC} ${BOLD_WHITE}Trial JP OFFICIAL                            ${YELLOW}║${NC}"
...
function show_menu() {
    ...
    echo -e "${YELLOW}╔══════════════════// ${CYAN}JP OFFICIAL${YELLOW} //═══════════════════╗${NC}"
    _draw_info_panel
